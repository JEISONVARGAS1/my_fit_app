...
/// Signature for [CustomSlidableActionWidget.onPressed].
typedef SlidableActionWidgetCallback = void Function(BuildContext context);
...
class CustomSlidableActionWidget extends StatelessWidget {
  /// Creates a [CustomSlidableActionWidget].
  ///
  ...
  /// other [CustomSlidableActionWidget]s.
  /// {@endtemplate}
  final int flex;
  ...
  /// {@endtemplate}
  final SlidableActionWidgetCallback? onPressed;
...
class SlidableActionWidget extends StatelessWidget {
  /// Creates a [SlidableActionWidget].
  ///
